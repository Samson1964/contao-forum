 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['forum'] = '{title_legend},name,type;{options_legend},forum_category;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
